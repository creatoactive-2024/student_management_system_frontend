...
const Checks = () => {
  ...
  const fetchData = async () => {
    ...
    await fetchDataCommon("checks", setData, setSelectedRowKeys, setLoading);
  };
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Checks</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          <Space>
            ...
            {/* <label style={{ marginRight: "10px" }}>Based On date of creation</label> */}
            Based On date of creation : : Print status
