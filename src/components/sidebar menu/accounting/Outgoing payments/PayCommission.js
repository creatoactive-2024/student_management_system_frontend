  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Pay Commission</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          <Space>
            ...
            <div style={{ marginRight: "10px" }}>
              <DatePicker
                placeholder="Date of creation (Invoice)"
            ...
            : :
            <Select style={{ width: 155 }} placeholder="-Credit-">
              <Option value="option1">option1</Option>
              <Option value="option">option</Option>
            </Select>
            <Select style={{ width: 155 }} placeholder="-Invoice(Gross)-">
              <Option value="option1">option1</Option>
              <Option value="option">option</Option>
            </Select>
            <Select style={{ width: 155 }} placeholder="-Agencies-">
              <Option value="option1">option1</Option>
              <Option value="option">option</Option>
            </Select>
          </Space>
