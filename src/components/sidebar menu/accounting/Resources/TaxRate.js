...
const TaxRate = () => {
  ...
  const fetchData = async () => {
    ...
    await fetchDataCommon("taxrates", setData, setSelectedRowKeys, setLoading);
  };
  ...
  const onFinish = async () => {
    ...
    const data = {
      ...
      note_english: values.note_english || null,
      // note_portuguese: values.note_portuguese || null,
      // note_spanish: values.note_spanish || null,
    };
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Tax Rate</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
          ...
          >
            ...
            >
              ...
              >
                ...
                />
                <Form.Item name="note_english" noStyle>
                  <Input
                    style={{
                      paddingLeft: "42px",
                    }}
            ...
            >
              ...
              >
                ...
                />
                <Form.Item name="note_spanish" noStyle>
                  <Input
                    style={{
                      paddingLeft: "42px",
                    }}
            ...
            >
              ...
              >
                ...
                />
                <Form.Item name="note_portuguese" noStyle>
                  <Input
                    style={{
                      paddingLeft: "42px",
                    }}
