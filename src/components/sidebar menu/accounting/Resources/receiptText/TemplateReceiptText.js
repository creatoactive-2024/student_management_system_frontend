  ...
  const handleEditButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/getdata`, {
        collectionName: "templatereceipttexts",
        id: selectedRecordId,
      });
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Template for Receipt Texts</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
...
export default TemplateReceiptText;
