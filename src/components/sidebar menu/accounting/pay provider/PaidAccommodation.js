...
import LineItemAccommodation from "./LineItemAccommodation";
...
const PaidAccommodation = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "paidaccommodations";
    const data = {
  ...
  const handleEditButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/getdata`, {
        collectionName: "paidaccommodations",
        id: selectedRecordId,
      });
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Pay provider</Breadcrumb.Item>
        <Breadcrumb.Item>Paid Accommodation</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          <Space>
            <Space>
              ...
              <Select style={{ width: 155 }} placeholder="--Payment method--">
              ...
              <Select style={{ width: 155 }} placeholder="--Cost category--">
                <Option value="option1">option1</Option>
                <Option value="option">option</Option>
              </Select>
              <Select style={{ width: 155 }} placeholder="--Accommodation--">
                <Option value="option1">option1</Option>
                <Option value="option">option</Option>
              </Select>
              <Select
                style={{ width: 155 }}
                placeholder="--Further processed--"
              >
                <Option value="option1">option1</Option>
                <Option value="option">option</Option>
              </Select>
      ...
      <br />
      <h5>Line items</h5>
      <LineItemAccommodation />
    </>
  );
};

export default PaidAccommodation;
