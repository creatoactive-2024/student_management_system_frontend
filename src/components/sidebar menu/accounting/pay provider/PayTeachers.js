...
const PayTeachers = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "payteachers";
    const data = {
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Pay Teachers</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          <Space>
            <Space>
              ...
              <Select style={{ width: 155 }} placeholder="--Teacher--">
                <Option value="option1">option1</Option>
                <Option value="option">option</Option>
              </Select>
            </Space>{" "}
