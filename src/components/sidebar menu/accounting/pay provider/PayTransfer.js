...
import { CsvExcelImport1 } from "../../commonComponents/ButtonsDropdown";
...
const PayTransfer = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "paytransfers";
    const data = {
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Pay Transfer</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
