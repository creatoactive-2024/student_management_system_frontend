...
const PayAccommodationProvider = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "payaccommodationproviders";
    const data = {
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Pay Accommodation Provider</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          <Space>
            <Select style={{ width: 155 }} placeholder="-Billing terms-">
...
export default PayAccommodationProvider;
