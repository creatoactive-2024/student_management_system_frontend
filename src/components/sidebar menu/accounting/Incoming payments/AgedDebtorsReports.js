...
const AgedDebtorsReports = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "incomingpayments";
    const data = {
  ...
  const handleEditButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/getdata`, {
        collectionName: "incomingpayments",
        id: selectedRecordId,
      });
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Aged Debtors Reports</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          <Space>
            ...
            <Select style={{ width: 155 }} placeholder="-Type-">
        ...
        >
          <Space>
            <label style={{ marginRight: "10px" }}>Reporting :</label>

            <Select style={{ width: 155 }} placeholder="7 days interval">
              <Option value="option1">option1</Option>
              <Option value="option">option</Option>
            </Select>
            <Select style={{ width: 155 }} placeholder="-4 intervals">
              <Option value="option1">option1</Option>
              <Option value="option">option</Option>
            </Select>
            <Select style={{ width: 155 }} placeholder="+4 intervals">
            ...
            <Select style={{ width: 155 }} placeholder="Without proforma">
              <Option value="option1">option1</Option>
              <Option value="option">option</Option>
            </Select>
          </Space>
...
export default AgedDebtorsReports;
