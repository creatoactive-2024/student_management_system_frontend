...
import TailorMadeReportForm from "./TailorMadeReportForm";
...
const TailorMadeReport = () => {
  ...
  const transformedData = data
    ? data.map((entry) => ({
        ...
        time_frame: entry.time_frame || null,
        type_of_report: entry.type_of_report || null,
  ...
  const handleEditButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/getdata`, {
        collectionName: "tailormadereports",
        id: selectedRecordId,
      });
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Tailor made reports</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
...
export default TailorMadeReport;
