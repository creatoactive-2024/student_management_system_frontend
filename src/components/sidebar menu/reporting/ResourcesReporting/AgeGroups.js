...
const AgeGroups = () => {
  ...
  const fetchData = async () => {
    ...
    await fetchDataCommon("agegroups", setData, setSelectedRowKeys, setLoading);
  };
  ...
  const transformedData = data
    ? data.map((entry) => ({
        ...
        age_from: entry.age_from || null,
        age_until: entry.age_until || null,
      }))
    : [];
  ...
  const onFinish = async () => {
    ...
    const collectionName = "agegroups";
    const data = {
      _id: selectedRecordId ? selectedRecordId : null,
      name: values.name || null,
      age_from: values.age_from || null,
      age_until: values.age_until || null,
    };
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Age Groups</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          ...
          >
            ...
            <Form.Item
              ...
              name="age_from"
              rules={[
                { required: true, message: "Please enter the Age from!" },
              ]}
            >
              <Input placeholder="Enter Age from" />
            </Form.Item>
            ...
            <Form.Item
              ...
              name="age_until"
              rules={[
                { required: true, message: "Please enter the Age until!" },
              ]}
            >
              <Input placeholder="Enter Age until" />
            </Form.Item>
