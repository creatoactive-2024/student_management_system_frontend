...
const ReportPages = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "reportpages";
    const data = {
      _id: selectedRecordId ? selectedRecordId : null,
      title: values.title || null,
      report_should_display: values.report_should_display || null,
    };
  ...
  const columns = [
    ...
    {
      title: "Report that should be displayed on that page",
      dataIndex: "report_should_display",
      key: "report_should_display",
    },
    {
      title: "Created by",
      dataIndex: "",
  ...
  const transformedData = data
    ? data.map((entry) => ({
        ...
        report_should_display: entry.report_should_display || null,
      }))
    : [];
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Report Pages</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          ...
          >
            ...
            <Form.Item
              name="report_should_display"
              label="Report that should be displayed on that page"
            >
              <Select mode="multiple" placeholder="Please select">
                <Option value="Agencies">Agencies</Option>
                <Option value="Attendence">Attendence</Option>
                <Option value="Demographics">Demographics</Option>
                <Option value="IELTs demographics">IELTs demographics</Option>
                <Option value="Invoiced accommodation amounts-Based on regristration date">
                  Invoiced accommodation amounts-Based on regristration date
                </Option>
                <Option value="November">November</Option>
                <Option value="Registration">Registration</Option>
                <Option value="Revenue">Revenue</Option>
                <Option value="Where did students come from?">
