...
const QuicReport = () => {
  ...
  const data = [
"Only booked courses with 10 or more lessons per week will be taken into consideration. Student weeks will be rounded up." 
  ];
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>QUIC Report</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div
        style={{
