...
const Cancellation_Fees = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "cancellationfees";
    const data = {
  ...
  const handleEditButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/getdata`, {
        collectionName: "cancellationfees",
        id: selectedRecordId,
      });
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Cancellation Fees</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        <Modal
          title="Add New Cancellation fees"
...
export default Cancellation_Fees;
