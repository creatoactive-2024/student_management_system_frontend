...
const PublicHolidays = () => {
  ...
  useEffect(() => {
    if (editingRecordData) {
      ...
      form.setFieldsValue({
        // date: editingRecordData.date ? moment(editingRecordData.date) : null,
        date: formattedDate,
      });
      document.getElementById("date-picker-public-holiday").value =
        formattedDate;
    }
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Marketing Resourses</Breadcrumb.Item>
        <Breadcrumb.Item>Public Holidays</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          ...
          >
            ...
            <Form.Item label="Annually" name="annually" valuePropName="checked">
              <Checkbox></Checkbox>
            </Form.Item>
            <Form.Item
              name="schools"
