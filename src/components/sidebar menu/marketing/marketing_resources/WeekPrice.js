...
const WeekPrice = () => {
  ...
  const transformedData = data
    ? data.map((entry) => ({
        ...
        additional_lesson: entry.additional_lesson ? "YES" : "NO",
  ...
  const onFinish = async () => {
    ...
    const collectionName = "weekprices";
    const data = {
      ...
      additional_lesson: values.additional_lesson || null,
    };
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Week Price</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
          ...
          >
            ...
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Please select Starting week",
                },
              ]}
            >
