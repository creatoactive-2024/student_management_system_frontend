...
const LessonPrice = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "lessonprices";
    const data = {
      ...
      additional_lesson: values.additional_lesson,
    };
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Lesson Price</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          ...
          >
            ...
            <Form.Item
              ...
              rules={[
                { required: true, message: "Please select Starting lesson!" },
              ]}
            >
              <Input placeholder="Enter starting_lesson" />
            </Form.Item>
            ...
            <Form.Item
              ...
              rules={[
                { required: true, message: "Please select Number of lessons!" },
              ]}
            >
              <Input placeholder="Enter number of lesson" />
            </Form.Item>

            <Form.Item label="Additional lesson" name="additional_lesson">
              <Checkbox></Checkbox>
            </Form.Item>
