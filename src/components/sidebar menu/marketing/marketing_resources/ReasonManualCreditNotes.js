...
const ReasonManualCreditNotes = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "manualcreditnotes";
    const data = {
  ...
  const columns = [
    ...
    {
      title: "Subject of the credit note",
  ...
  const handleEditButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/getdata`, {
        collectionName: "manualcreditnotes",
        id: selectedRecordId,
      });
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Reason Manual Credit Notes</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        <Modal
          title="Add New credit note subject"
        ...
        >
          <Form
            ...
            form={form}
          >
            <Form.Item label="Name" name="subject_credit_note">
        ...
        <Modal
          title="Edit credit note subject"
...
export default ReasonManualCreditNotes;
