...
const Sponsors = () => {
  ...
  const fetchData = async () => {
    ...
    await fetchDataCommon("sponsors", setData, setSelectedRowKeys, setLoading);
  };
  ...
  const transformedData = data
    ? data.map((entry) => ({
        ...
        addon_address: entry.addon_address || null,
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Sponsors</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
