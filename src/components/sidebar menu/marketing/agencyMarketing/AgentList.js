...
const AgentList = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "agentlists";
    const data = {
      _id: selectedRecordId ? selectedRecordId : null,
      title: values.title || null,
      description: values.description || null,
      agencies: values.agencies || null,
    };
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Agent List</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
          ...
          >
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Please select contact persons",
                },
              ]}
            >
            ...
            <Form.Item
              ...
              rules={[
                {
                  message: "Please select Agencies",
                  type: "array",
                },
              ]}
            >
              <Select mode="multiple" placeholder="Please select">
                ...
                <Option value="A Queens english">A Queens english</Option>
                <Option value="A & S Associates">C</Option>
