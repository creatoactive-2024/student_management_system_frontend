...
const AgentCategory = () => {
  ...
  const handleEditButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/getdata`, {
        collectionName: "agentcategories",
        id: selectedRecordId,
      });
  ...
  const onFinish = async () => {
    ...
    const collectionName = "agentcategories";
    const data = {
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Agent Category</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
