...
const CommissionCategories = () => {
  ...
  const handleEditButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/getdata`, {
        collectionName: "commissioncategories",
        id: selectedRecordId,
      });
  ...
  const onFinish = async () => {
    ...
    const collectionName = "commissioncategories";
    const data = {
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Commission Categories</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        <Modal
          title="Add New commission categories"
        ...
        <Modal
          title="Edit commission categories"
