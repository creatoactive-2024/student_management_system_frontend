...
const AddScales = () => {
  ...
  const fetchData = async () => {
    ...
    await fetchDataCommon("addscales", setData, setSelectedRowKeys, setLoading);
  };
  ...
  const columns = [
    ...
    {
      title: "No. of Valuation",
      dataIndex: "number_of_valuation",
      key: "number_of_valuation",
    },
    {
      title: "Created by",
      dataIndex: "",
  ...
  const transformedData = data
    ? data.map((entry) => ({
        ...
        number_of_valuation: entry.number_of_valuation || null,
      }))
    : [];
  ...
  const onFinish = async () => {
    ...
    const collectionName = "addscales";
    const data = {
      _id: selectedRecordId ? selectedRecordId : null,
      name: values.name || null,
      number_of_valuation: values.number_of_valuation || null,
        ...
        >
          ...
          >
            ...
            <Form.Item
              ...
              name="number_of_valuation"
              rules={[
                {
                  required: true,
                  message: "Please enter the Number of Valuation!",
                },
              ]}
            >
              <Input type="Number" placeholder="Enter Number of Valuation" />
            </Form.Item>
