...
const TypeOfContact = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "typeofcontacts";
    const data = {
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Type of contact</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
