...
import ComplaintSubCategories from "./ComplaintSubCategories";
...
const ComplaintCategories = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "complaintcategories";
    const data = {
  ...
  const handleEditButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/getdata`, {
        collectionName: "complaintcategories",
        id: selectedRecordId,
      });
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Complaint Categories & SubCategories</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        <Modal
          title="Add New Complaint Categories"
        ...
        <Modal
          title="Edit Complaint Categories"
