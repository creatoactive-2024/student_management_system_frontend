...
const CourseCategories = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "coursecategory";
    const data = {
      ...
      block_content: values.block_content || null,
      cost_center: values.cost_center || null,
      class_for_icon: values.class_for_icon || null,
    };
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Course Categories</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          ...
          >
            ...
            <Form.Item
              label="Block content in class scheduling"
              name="block_content"
              rules={[
                {
                  required: true,
                  message:
                    "Please enter the Block content in class scheduling!",
                },
              ]}
            >
              <Input.TextArea />
            ...
            <hr />
            <h5>Frontend</h5>
            <Form.Item label="Class for icons" name="class_for_icon">
