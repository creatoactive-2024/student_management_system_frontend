...
const CourseLevel = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "courselevels";
    const data = {
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Course Level</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          ...
          >
            ...
            <Form.Item
              ...
              name="nickname"
              rules={[
                { required: true, message: "Please enter the CEFR Level!" },
              ]}
            >
              <Input placeholder="Enter CEFR Level" />
            </Form.Item>
