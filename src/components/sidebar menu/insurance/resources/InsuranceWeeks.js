...
const InsuranceWeeks = () => {
  ...
  const transformedData = data
    ? data.map((entry) => ({
        ...
        number_of_weeks: entry.number_of_weeks || null,
        additional_week: entry.additional_week ? "Yes" : "No",
  ...
  const onFinish = async () => {
    ...
    const collectionName = "insuranceweeks";
    const data = {
      _id: selectedRecordId ? selectedRecordId : null,
      title: values.title || null,
      number_of_weeks: values.number_of_weeks || null,
      additional_week: values.additional_week || null,
    };
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Weeks</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          ...
          >
            ...
            <Form.Item label="Number of weeks" name="number_of_weeks">
