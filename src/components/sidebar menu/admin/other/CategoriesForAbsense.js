...
const CategoriesForAbsense = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "categoryforabsences";
    const data = {
  ...
  const handleEditButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/getdata`, {
        collectionName: "categoryforabsences",
        id: selectedRecordId,
      });
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Categories For Absense</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        <Modal
          title="Add New Category for absense"
        ...
        <Modal
          title="Edit Category for absense"
...
export default CategoriesForAbsense;
