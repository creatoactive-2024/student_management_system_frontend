...
const CommunicationCategories = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "communicationcategories";
    const data = {
  ...
  const handleEditButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/getdata`, {
        collectionName: "communicationcategories",
        id: selectedRecordId,
      });
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Communication Categories</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
...
export default CommunicationCategories;
