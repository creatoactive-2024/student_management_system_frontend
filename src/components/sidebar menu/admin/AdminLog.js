...
const AdminLog = () => {
  ...
  const fetchData = async () => {
    ...
    await fetchDataCommon("", setData, setSelectedRowKeys, setLoading);
  };
  ...
  const onFinish = async () => {
    ...
    const data = {
      ...
      released_for_student_app: values.released_for_student_app || null,
    };
  ...
  const handleDeleteModalOk = async () => {
    // Call the common delete API with the selected record IDs
    await handleDelete("", selectedRowKeys, fetchData, setDeleteModalVisible);
  };
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Background Task</Breadcrumb.Item>
        <Breadcrumb.Item>Failed Background Task</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          ...
          >
            ...
            <Form.Item
              label="Default: Released for Student App"
              name="released_for_student_app"
            >
              <Checkbox></Checkbox>
            </Form.Item>
