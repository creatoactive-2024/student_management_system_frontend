...
const EmailSpool = () => {
  ...
  const handleSend = () => {
    // Logic to export data as CSV
    message.success("Send logic goes here");
  };
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Email spool</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          ...
          <Space>
            ...
            <Button icon={<AiOutlineSend  />} onClick={handleSend}>
              Send
            </Button>
          </Space>
        </div>
