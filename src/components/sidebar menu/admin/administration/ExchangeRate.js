...
import { AiOutlineDollarCircle, AiOutlineSync } from "react-icons/ai";
...
const ExchangeRate = () => {
  ...
  const onFinish = async () => {
    ...
    const data = {
      ...
      update_time: values.update_time || null,
    };
  ...
  const transformedData = data
    ? data.map((entry) => ({
        ...
        update_time: entry.update_time
          ? moment(entry.update_time).format("hh:mm A")
          : null,
      }))
    : [];
  ...
  useEffect(() => {
    if (editingRecordData) {
      form.setFieldsValue({
        name: editingRecordData.name || null,
        update_time: editingRecordData.update_time
          ? moment(editingRecordData.update_time, "hh:mm")
          : null,
      });
    }
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Exchange rates</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          <Space>
            <Button icon={<AiOutlineSync />} onClick={handleAssignments}>
              Update exchange rates
            </Button>
            <Button
              icon={<AiOutlineDollarCircle />}
              onClick={handleAccessRights}
            >
        ...
        <Modal
          title="Add New exchange rate table"
        ...
        >
          ...
          >
            ...
            <Form.Item label="Update time" name="update_time">
              <TimePicker
                format="HH:mm"
        ...
        <Modal
          title="Edit exchange rate table"
