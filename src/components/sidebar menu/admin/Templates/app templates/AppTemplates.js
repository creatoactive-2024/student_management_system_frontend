...
const AppTemplates = () => {
  ...
  const transformedData = data
    ? data.map((entry) => ({
        ...
        recipient_group: entry.recipient_group || null,
      }))
    : [];
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>App Templates</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
