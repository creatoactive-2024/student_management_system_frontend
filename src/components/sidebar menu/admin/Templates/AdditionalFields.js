...
const AdditionalFields = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "additionalfields";
    const data = {
      _id: selectedRecordId ? selectedRecordId : null,
      name: values.name || null,
      margin_left: values.margin_left || null,
      margin_top: values.margin_top || null,
      width: values.width || null,
      type: values.type || null,
      display_on: values.display_on || null,
      edit_content_generating_pdf: values.edit_content_generating_pdf || null,
      font: values.font || null,
      font_style: values.font_style || null,
      font_size: values.font_size || null,
      char_spacing: values.char_spacing || null,
    };
  ...
  const columns = [
    ...
    {
      title: "Margin left",
      dataIndex: "margin_left",
      key: "margin_left",
    },
    {
      title: "Margin top",
      dataIndex: "margin_top",
      key: "margin_top",
    },
    {
      title: "Width (mm)",
  ...
  const transformedData = data
    ? data.map((entry) => ({
        ...
        margin_left: entry.margin_left || null,
        margin_top: entry.margin_top || null,
        width: entry.width || null,
        display_on: entry.display_on || null,
        font: entry.font || null,
        font_size: entry.font_size || null,
        font_style: entry.font_style || null,
      }))
    : [];
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Additional Fields</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          ...
          >
            ...
            <Form.Item label="Margin left (mm)" name="margin_left">
              <Input placeholder="0.00" />
            </Form.Item>
            <Form.Item label="Margin top (mm)" name="margin_top">
              <Input placeholder="0.00" />
            </Form.Item>
            ...
            <Form.Item label="Display on" name="display_on">
              <Select placeholder="Select Display on">
                <Option value="first page">first page</Option>
              </Select>
            </Form.Item>

            <Form.Item
              label="Edit content when generating PDF"
              name="edit_content_generating_pdf"
            ...
            <Form.Item label="Font style" name="font_style">
              <Select placeholder="Select font style">
                <Option value="Normal">Normal</Option>
              </Select>
            </Form.Item>

            <Form.Item label="Font size" name="font_size">
              <Input placeholder="12.00" />
            </Form.Item>
            <Form.Item label="Character spacing" name="char_spacing">
