...
const ContractType = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "contracttypes";
    const data = {
      ...
      available_for_school: values.available_for_school || null,
    };
  ...
  const transformedData = data
    ? data.map((entry) => ({
        ...
        contract_type: entry.contract_type || null,
  ...
  const data1 = [
    ...
    "Ongoing number per partner- %partner- %partner_counter",
    "Ongoing number-%contract_counter",
    "Number of frame contract-%basic contract",
  ];
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Contract Type</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          ...
          >
            ...
            <Form.Item label="To be used for" name="used_for">
