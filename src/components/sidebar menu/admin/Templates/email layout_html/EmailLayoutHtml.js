...
import EmailLayoutHtmlForm from "./EmailLayoutHtmlForm";
  ...
  const handleEditButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/getdata`, {
        collectionName: "emailhtmllayouts",
        id: selectedRecordId,
      });
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Email layout (html only)</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        <Modal
          title="Add New Email layout (html only)"
        ...
        <Modal
          title="Edit Email layout (html only)"
...
export default EmailLayoutHtml;
