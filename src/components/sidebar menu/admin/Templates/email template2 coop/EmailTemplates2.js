...
import EmailTemplates2Form from "./EmailTemplates2Form";
...
const EmailTemplates2 = () => {
  ...
  const columns = [
    ...
    {
      title: "Correspondence Languages",
      dataIndex: "correspondence_languages",
      key: "correspondence_languages",
    },
    {
      title: "Available in the following overviews",
      dataIndex: "available_overview",
      key: "available_overview",
    },
    {
      title: "HTML",
      dataIndex: "html",
    ...
    {
      title: "Available for the following schools",
      dataIndex: "available_school",
      key: "available_school",
    },
  ...
  const transformedData = data
    ? data.map((entry) => ({
        ...
        correspondence_languages: entry.correspondence_languages || null,
        available_overview: entry.available_overview || null,
        html: entry.html === "true" ? "Yes" : "No" || null,
        available_school: entry.available_school || null,
  ...
  const handleEditButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/getdata`, {
        collectionName: "email2templates",
        id: selectedRecordId,
      });
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Email Templates 2 (Co-Op)</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
