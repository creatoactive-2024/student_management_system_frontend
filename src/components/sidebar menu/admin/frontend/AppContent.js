...
const AppContent = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "apicontents";
    const data = {
      ...
      content_english: values.content_english || null,
      // content_spanish: values.content_spanish || null,
      // content_portuguese: values.content_portuguese || null,
    };
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>App Content</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          <Form
            ...
            form={form}
          >
            <Form.Item label="Released" name="released" valuePropName="checked">
              <Checkbox></Checkbox>
            </Form.Item>
            ...
            >
              ...
              >
                ...
                />
                <Form.Item name="content_english" noStyle>
                  <Input
                    style={{
                      paddingLeft: "42px",
                    }}
            ...
            >
              ...
              >
                ...
                />
                <Form.Item name="content_spanish" noStyle>
                  <Input
                    style={{
                      paddingLeft: "42px",
                    }}
            ...
            >
              ...
              >
                ...
                />
                <Form.Item name="content_portuguese" noStyle>
                  <Input
                    style={{
                      paddingLeft: "42px",
                    }}
