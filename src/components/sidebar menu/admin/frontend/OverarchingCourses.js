...
const OverarchingCourses = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "overarchingcourses";
    const data = {
  ...
  const handleEditButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/getdata`, {
        collectionName: "overarchingcourses",
        id: selectedRecordId,
      });
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Overarching Courses</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        <Modal
          title="Add New overarching course"
...
export default OverarchingCourses;
