...
const OnlineForm = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "onlineforms";
    const data = {
      ...
      standard_language: values.standard_language || null,
    };
  ...
  const transformedData = data
    ? data.map((entry) => ({
        ...
        standard_language: entry.standard_language || null,
      }))
    : [];
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Online forms</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          ...
          >
            ...
            <Form.Item
              label="Schools"
              name="schools"
              rules={[{ required: true, message: "Please select schools!" }]}
            >
