...
const FrontendTranslation = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "frontendtranslations";
    const data = {
  ...
  const handleEditButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/getdata`, {
        collectionName: "frontendtranslations",
        id: selectedRecordId,
      });
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Frontend Translation</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          <Space>
            <Select
              ...
              //   value={filterValue1}
            >
              <Option value="Not yet translated">Not yet translated</Option>
...
export default FrontendTranslation;
