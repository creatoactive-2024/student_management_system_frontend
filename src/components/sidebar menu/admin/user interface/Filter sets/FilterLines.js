...
import FilterLines1 from "./FilterLines1";
...
const FilterLines = () => {
  ...
  const handleFilter1Change = () => {
    ...
    message.success("button logic goes here");
  };
  ...
  return (
    <>
      <div>
        ...
        <Modal
          title="Add New optional condition"
