...
const CustomFields = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "customfields";
    const data = {
      _id: selectedRecordId ? selectedRecordId : null,
      available_overviews: values.available_overviews || null,
      type: values.type || null,
      name_text_field: values.name_text_field || null,
      display_list: values.display_list || null,
      multilingualism: values.multilingualism || null,
      mandatory: values.mandatory || null,
      specific_requirement: values.specific_requirement || null,
      max_characters: values.max_characters || null,
  ...
  const columns = [
    ...
    {
      title: "Title",
      dataIndex: "available_overviews",
      key: "available_overviews",
    },
    {
      title: "Description",
    ...
    {
      title: "Displayed in list",
      dataIndex: "display_list",
      key: "display_list",
    },
  ...
  const transformedData = data
    ? data.map((entry) => ({
        _id: entry._id || null,
        available_overviews: `${entry.available_overviews} ` || null,
        description: entry.description || null,
        type: entry.type || null,
        display_list: entry.display_list ? "YES" : "NO",
        mandatory: entry.mandatory ? "YES" : "NO",
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Custom fields</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
        ...
        >
          ...
          >
            <Form.Item
              ...
              name="available_overviews"
              rules={[
                {
                  required: true,
                  message:
                    "Please select Available in the following overviews!",
                },
              ]}
            >
            ...
            <Form.Item label="Name of text field" name="name_text_field">
              <Input />
            </Form.Item>
            ...
            <Form.Item
              label={
                <span>
                  Displayed in list&nbsp;
                  <Tooltip title="Displayed in list">
            ...
            <Form.Item label="Specific requirement" name="specific_requirement">
              <Select placeholder="SELECT..." onChange={handleChange}>
                <Option value="No validation">No validation</Option>
              </Select>
            </Form.Item>

            <Form.Item label="Max. characters" name="max_characters">
              <Input />
            </Form.Item>
