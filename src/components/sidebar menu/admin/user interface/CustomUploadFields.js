...
const CustomUploadFields = () => {
  ...
  const onFinish = async () => {
    ...
    const collectionName = "customuploadfields";
    const data = {
  ...
  const handleEditButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`${baseURL}/getdata`, {
        collectionName: "customuploadfields",
        id: selectedRecordId,
      });
  ...
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item>Custom upload fields</Breadcrumb.Item>
      </Breadcrumb>
      <hr />
      <div>
        <div
...
export default CustomUploadFields;
